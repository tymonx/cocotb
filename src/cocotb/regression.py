...
class RegressionManager:
    ...
    def __init__(self) -> None:
        ...
        # Feature flags
        preview = _env.as_list("COCOTB_PREVIEW")
        self._feature_xfail_in_results = "XFAIL_IN_RESULTS" in preview
        """Use the ``XFAIL`` status instead of using the ``PASS`` status for xfailed tests in the terminal results summary (like pytest)."""
    ...
    def _record_test_xfail(
        ...
        if self._feature_xfail_in_results:
